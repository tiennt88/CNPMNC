...
<sd:TitlePane id="tabletReport"  key="Thông tin">
    <s:form  id="tabletReportForm"  name="tabletReportForm"  method="POST">
        <table width="100%">
            <tr>
                <td>
...
//        window.location = "tabletModelCompareExport!exportExcel.do";
        sd.connector.post("tabletReportExport!exportExcel.do","result","tabletReportForm");
    }
