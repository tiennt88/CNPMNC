<%-- 
    Document   : tabletPriceDifferentLevelPopUp
...
<sd:TitlePane key="Danh Sách Các Web Bán" id="tabletPriceDifferentLevelPopUp">

    <form id="tabletPriceDifferentLevelPopUpForm" name="tabletPriceDifferentLevelPopUpForm">
        <div id="tabletPriceDifferentLevelPopUpDiv" >
            <sd:DataGrid clientSort="true" getDataUrl="tabletPriceDifferentLevelPopUpSearch!onSearchPopUp.do" id="tabletPriceDifferentLevelPopUpGird" style="width: 100%; height: 100%;" rowsPerPage="500">
...
<script>
    ...
    dojo.connect(dijit.byId("tabletPriceDifferentLevelPopUpGird"), "onCellClick", function (e) {
        var grid = dijit.byId("tabletPriceDifferentLevelPopUpGird");
