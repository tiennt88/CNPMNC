...
<sd:TitlePane id="mobileModelNew"  key="Thông tin">
    <s:form  id="mobileModelNewForm"  name="mobileModelNewForm"  method="POST">
        <table width="100%">
            <tr>
                <td>
    ...
    <br>
<sd:TitlePane key="Danh Sách Model Mới" id="mobileModelNewList">
    <form id="mobileModelNewListForm" name="mobileModelNewListForm">
        <div id="mobileModelNewListDiv" >
            <sd:DataGrid clientSort="true" getDataUrl="mobileModelNewSearch!onSearch.do" id="mobileModelNewListGird" style="width: 100%; height: 100%;" rowsPerPage="10">
...
<script>
    ...
    page.onSearch = function(){
        ...
        dijit.byId('mobileModelNewListGird').vtReload("mobileModelNewSearch!onSearch.do","mobileModelNewForm",null,callback) ;
    }

    dojo.connect(dijit.byId("mobileModelNewListGird"), "onCellClick", function (e) {
        var grid = dijit.byId("mobileModelNewListGird");
...
//        window.location = "mobileModelNewExport!exportExcel.do";
        sd.connector.post("mobileModelNewExport!exportExcel.do","result","mobileModelNewForm");
    }
