...
<!--                <h1>Thông Tin Chi Tiết :</h1>-->
            ...
            <tr>
                <td>
                    <sd:TextBox id="web"   name="mobile.web" key="Web" trim="true" readonly="true" maxlength="50"/>
                </td>
                <td>
                    <sd:TextBox id="type"   name="mobile.type" key="Loại" trim="true" readonly="true" maxlength="50"/>
                </td>
                <td>
                    <sd:TextBox id="brand"   name="mobile.brand" key="Hãng" trim="true" readonly="true" maxlength="50"/>
                </td>
            </tr>
            <tr>
                <td>
                    <sd:TextBox id="name"   name="mobile.name" key="Tên" trim="true" readonly="true" maxlength="250"/>
                </td>
                <td>
                    <sd:TextBox id="model"   name="mobile.model" key="Model" trim="true" maxlength="250" readonly="true"/>
                </td>

                <td>
                    <sd:TextBox id="partno" name="mobile.partno" key="PartNo" trim="true" readonly="true" maxlength="50"/>
                </td>
            </tr>

            <tr>
                <td>
                    <sd:TextBox id="price"   name="mobile.price" key="Giá" trim="true" maxlength="50" readonly="true" />
                </td>
                <td>
                    <sd:TextBox id="storage"  name="mobile.storage" key="Bộ nhớ trong" trim="true" maxlength="50" readonly="true" />
                </td>
                <td>
                    <sd:TextBox id="ram"   name="mobile.ram" key="Ram" trim="true" maxlength="50" readonly="true" />
                </td>
            </tr>
            <tr>
                <td>
                    <sd:TextBox id="screen"   name="mobile.screen" key="Màn Hình" trim="true" maxlength="50" readonly="true" />
                </td>
                <td>
                    <sd:TextBox id="cpu"   name="mobile.cpu" key="CPU" trim="true" maxlength="50" readonly="true" />
                </td>
                <td>
                    <sd:TextBox id="os"   name="mobile.os" key="OS" trim="true" maxlength="50" readonly="true" />
                </td>
            </tr>
            <tr>
                <td>
                    <sd:TextBox id="backCamera"   name="mobile.backCamera" key="Camera Chính" trim="true" maxlength="50" readonly="true" />
                </td>
                <td>
                    <sd:TextBox id="frontCamera"   name="mobile.frontCamera" key="Camera Phụ" trim="true" maxlength="50" readonly="true" />
                </td>
                <td>
                    <sd:TextBox id="battery"   name="mobile.battery" key="Pin" trim="true" maxlength="50" readonly="true" />
                </td>
            </tr>
            <tr>
                <td>
                    <sd:TextBox id="sim"   name="mobile.sim" key="Sim" trim="true" maxlength="50" readonly="true" />
                </td>
                <td>
                    <sd:TextBox id="color"   name="mobile.color" key="Màu" trim="true" maxlength="50" readonly="true" />
                </td>
                <td>
                    <sd:TextBox id="promotion"   name="mobile.promotion" key="Khuyến Mại" trim="true" maxlength="500" readonly="true" />
                </td>
            </tr>
        </table>
...
<sd:TitlePane key="Danh Sách Các Web Bán" id="mobileCompareList">
    ...
    <form id="mobileCompareListForm" name="mobileCompareListForm">
        <div id="mobileCompareListDiv" >
            <sd:DataGrid clientSort="true" getDataUrl="mobileCompareSearch!onSearch.do" id="mobileCompareListGird" style="width: 100%; height: 100%;" rowsPerPage="50">
