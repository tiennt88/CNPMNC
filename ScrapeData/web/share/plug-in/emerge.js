...
notification = function(type,text){
    ...
    if(type.toUpperCase() == 'ERROR'){
            ...
            $( '#errorNotification' ).emerge({
              theme: 'emerge-base top-center alert'
            });
    }else if(type.toUpperCase() == 'SUCCESS'){

            $('#successNotification').text(text);
            $('#successNotification').emerge({
              theme: 'emerge-base top-center success'
            });
    }else{

            $('#infoNotification').text(text);
            $('#infoNotification').emerge({
              theme: 'emerge-base top-center info'
            });
    }
