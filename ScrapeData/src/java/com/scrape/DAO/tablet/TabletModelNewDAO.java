 ...
 * @author KeyLove
 */
public class TabletModelNewDAO extends BaseHibernateDAOMDB{
...
//            String downFile = ServletActionContext.getServletContext().getRealPath(rb.getString(Constans.DOWNLOAD_FILE_PATH) + "TabletModelNew_"+random.nextInt(1000)+".xlsx");
            String downFile = rb.getString(Constans.DOWNLOAD_FILE_PATH) + "TabletModelNew_"+random.nextInt(1000)+".xlsx";
