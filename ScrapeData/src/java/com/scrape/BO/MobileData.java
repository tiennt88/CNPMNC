...
public class MobileData{
    ...
    public MobileData(long id) {
        this.id = id;
    }
    public MobileData(long id, String web, String type, String brand, String name, String link, String price, Long priceNumber, String promotion, String description, String isactive, Date createDate, Date lastUpdate) {
       this.id = id;
       this.web = web;
       this.type = type;
       this.brand = brand;
    ...
    @Column(name="ISACTIVE", length=1, columnDefinition ="Y")
