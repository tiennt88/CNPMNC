...
/**
 * TabletConfiguration generated by hbm2java
 */
@Entity
@Table(name="TABLET_CONFIGURATION"
    ,schema="dbo"
    , uniqueConstraints = @UniqueConstraint(columnNames="TABLET_DATA_ID") 
)
public class TabletConfiguration{
    ...
    public TabletConfiguration(long id, long tabletDataId) {
        this.id = id;
        this.tabletDataId = tabletDataId;
    }
    public TabletConfiguration(long id, long tabletDataId, String itemCode, String partno, String model, String screenText, String cpuText, String ramText, String osText, String BCameraText, String FCameraText, String storageText, String batteryText, String simText, String screen, String cpu, String speed, String ram, String os, String BCamera, String FCamera, String storage, String battery, String sim, Date createDate, Date lastUpdate, String color) {
       this.id = id;
       this.tabletDataId = tabletDataId;
    ...
    @Column(name="TABLET_DATA_ID", unique=true, nullable=false, precision=18, scale=0)
