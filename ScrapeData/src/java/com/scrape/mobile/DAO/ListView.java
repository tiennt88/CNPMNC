...
//    private static final long serialVersionUID = -5496740048118868287L;
//    private List<ListEntry> myList;
//
//    @Actions({
//	    @Action(value = "/list-view", results = { @Result(location = "mobile/list-view.jsp", name = "success") }),
//	    @Action(value = "/list-view-counter", results = { @Result(location = "mobile/list-view-counter.jsp", name = "success") }) })
